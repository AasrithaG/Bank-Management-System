...
class Bank:
    ...
    def deposit(self, amount):
        temp = db_query(
            f"SELECT balance,account_number  FROM customers WHERE username = '{self.__username}';")
        ...
        if amount > temp[0][0]:
            ...
            if temp2 == []:
                ...
                db_query(f"INSERT INTO {self.__username}_transaction VALUES ("
                         ...
                         f")")
                print(
                    f"{self.__username} Amount is Successfully Tranferred from your Account {self.__account_number}")